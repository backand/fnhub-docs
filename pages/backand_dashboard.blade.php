          ...
          <li>
            <a href="#backand-dashboard" class="toc-h1 toc-link" data-title="Backand Dashboard">Backand Dashboard</a>
              <ul class="toc-list-h2">
                  <li>
                    <a href="#navigation-mapping" class="toc-h2 toc-link" data-title="Backand Dashboard">Navigation mapping</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#functions-amp-integrations" class="toc-h3 toc-link" data-title="Backand Dashboard">Functions &amp; Integrations</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#database" class="toc-h3 toc-link" data-title="Backand Dashboard">Database</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#security" class="toc-h3 toc-link" data-title="Backand Dashboard">Security</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#admin" class="toc-h3 toc-link" data-title="Backand Dashboard">Admin</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#docs-amp-api" class="toc-h2 toc-link" data-title="Backand Dashboard">Docs &amp; API</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#examples" class="toc-h3 toc-link" data-title="Backand Dashboard">Examples</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#kickstart-tutorials" class="toc-h3 toc-link" data-title="Backand Dashboard">Kickstart Tutorials</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#existing-app-tutorials" class="toc-h3 toc-link" data-title="Backand Dashboard">Existing App Tutorials</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#realtime-database" class="toc-h3 toc-link" data-title="Backand Dashboard">Realtime Database</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#documentation" class="toc-h3 toc-link" data-title="Backand Dashboard">Documentation</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#rest-api-playground" class="toc-h3 toc-link" data-title="Backand Dashboard">REST API Playground</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#objects" class="toc-h2 toc-link" data-title="Backand Dashboard">Objects</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#model" class="toc-h3 toc-link" data-title="Backand Dashboard">Model</a>
                            <!-- Nest 4 levels -->
                              <ul class="toc-list-h4">
                                  <li>
                                    <a href="#model-diagram" class="toc-h4 toc-link" data-title="Backand Dashboard">Model Diagram</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#model-json" class="toc-h4 toc-link" data-title="Backand Dashboard">Model JSON</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#database-pending" class="toc-h4 toc-link" data-title="Backand Dashboard">Database (pending)</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                              </ul>
                          </li>
                          <li>
                            <a href="#object-list" class="toc-h3 toc-link" data-title="Backand Dashboard">Object List</a>
                            <!-- Nest 4 levels -->
                              <ul class="toc-list-h4">
                                  <li>
                                    <a href="#data-tab" class="toc-h4 toc-link" data-title="Backand Dashboard">Data tab</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#actions-tab" class="toc-h4 toc-link" data-title="Backand Dashboard">Actions tab</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#security-tab" class="toc-h4 toc-link" data-title="Backand Dashboard">Security tab</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#settings-tab" class="toc-h4 toc-link" data-title="Backand Dashboard">Settings tab</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#rest-api-tab" class="toc-h4 toc-link" data-title="Backand Dashboard">REST API tab</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                              </ul>
                          </li>
                  ...
                  <li>
                    <a href="#queries" class="toc-h2 toc-link" data-title="Backand Dashboard">Queries</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#query-list" class="toc-h3 toc-link" data-title="Backand Dashboard">Query List</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#create-a-query" class="toc-h3 toc-link" data-title="Backand Dashboard">Create a query</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#update-an-existing-query" class="toc-h3 toc-link" data-title="Backand Dashboard">Update an existing query</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#test-a-query" class="toc-h3 toc-link" data-title="Backand Dashboard">Test a query</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#background-jobs" class="toc-h2 toc-link" data-title="Backand Dashboard">Background Jobs</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#create-a-job" class="toc-h3 toc-link" data-title="Backand Dashboard">Create a job</a>
                            <!-- Nest 4 levels -->
                              <ul class="toc-list-h4">
                                  <li>
                                    <a href="#advanced-options" class="toc-h4 toc-link" data-title="Backand Dashboard">Advanced Options</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                              </ul>
                          </li>
                          <li>
                            <a href="#update-an-existing-job" class="toc-h3 toc-link" data-title="Backand Dashboard">Update an existing job</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#test-a-job" class="toc-h3 toc-link" data-title="Backand Dashboard">Test a job</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#run-background-job-using-rest-api" class="toc-h3 toc-link" data-title="Backand Dashboard">Run background job using REST API</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#test-background-job" class="toc-h3 toc-link" data-title="Backand Dashboard">Test background job</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#analytics" class="toc-h2 toc-link" data-title="Backand Dashboard">Analytics</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#reports" class="toc-h3 toc-link" data-title="Backand Dashboard">Reports</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#security-amp-auth" class="toc-h2 toc-link" data-title="Backand Dashboard">Security &amp; Auth</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#security-configuration" class="toc-h3 toc-link" data-title="Backand Dashboard">Security configuration</a>
                            <!-- Nest 4 levels -->
                              <ul class="toc-list-h4">
                                  <li>
                                    <a href="#anonymous-access" class="toc-h4 toc-link" data-title="Backand Dashboard">Anonymous Access</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#public-app" class="toc-h4 toc-link" data-title="Backand Dashboard">Public App</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#custom-pages" class="toc-h4 toc-link" data-title="Backand Dashboard">Custom pages</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#sign-up-email-verification" class="toc-h4 toc-link" data-title="Backand Dashboard">Sign-up Email Verification</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                              </ul>
                          </li>
                          <li>
                            <a href="#social-amp-keys" class="toc-h3 toc-link" data-title="Backand Dashboard">Social &amp; Keys</a>
                            <!-- Nest 4 levels -->
                              <ul class="toc-list-h4">
                                  <li>
                                    <a href="#master-token" class="toc-h4 toc-link" data-title="Backand Dashboard">Master Token</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#api-signup-token" class="toc-h4 toc-link" data-title="Backand Dashboard">API Signup Token</a>
                                    <!-- Nest 5 levels -->
                                  </li>
                                  <li>
                                    <a href="#social-configuration" class="toc-h4 toc-link" data-title="Backand Dashboard">Social Configuration</a>
                                    <!-- Nest 5 levels -->
                                      <ul class="toc-list-h5">
                                          <li>
                                            <a href="#social-redirect-uris" class="toc-h5 toc-link" data-title="Backand Dashboard">Social Redirect URIs</a>
                                          </li>
                                          <li>
                                            <a href="#github-app-configuration" class="toc-h5 toc-link" data-title="Backand Dashboard">GitHub App Configuration</a>
                                          </li>
                                          <li>
                                            <a href="#google-app-configuration" class="toc-h5 toc-link" data-title="Backand Dashboard">Google App Configuration</a>
                                          </li>
                                          <li>
                                            <a href="#facebook-app-configuration" class="toc-h5 toc-link" data-title="Backand Dashboard">Facebook App Configuration</a>
                                          </li>
                                          <li>
                                            <a href="#twitter-app-configuration" class="toc-h5 toc-link" data-title="Backand Dashboard">Twitter App Configuration</a>
                                          </li>
                                          <li>
                                            <a href="#local-adfs-app-configuration" class="toc-h5 toc-link" data-title="Backand Dashboard">Local ADFS App Configuration</a>
                                          </li>
                                          <li>
                                            <a href="#azure-ad-app-configuration" class="toc-h5 toc-link" data-title="Backand Dashboard">Azure AD App Configuration</a>
                                          </li>
                                      </ul>
                                  </li>
                              </ul>
                          ...
                          <li>
                            <a href="#registered-users" class="toc-h3 toc-link" data-title="Backand Dashboard">Registered Users</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#team" class="toc-h3 toc-link" data-title="Backand Dashboard">Team</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#security-actions-backand-dashboard" class="toc-h3 toc-link" data-title="Backand Dashboard">Security Actions (Backand Dashboard)</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#security-templates" class="toc-h3 toc-link" data-title="Backand Dashboard">Security Templates</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#hosting" class="toc-h2 toc-link" data-title="Backand Dashboard">Hosting</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#configuration" class="toc-h3 toc-link" data-title="Backand Dashboard">Configuration</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#hosting-files" class="toc-h3 toc-link" data-title="Backand Dashboard">Hosting files</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#storage-files" class="toc-h3 toc-link" data-title="Backand Dashboard">Storage files</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#log" class="toc-h2 toc-link" data-title="Backand Dashboard">Log</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#api-requests" class="toc-h3 toc-link" data-title="Backand Dashboard">API Requests</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#console" class="toc-h3 toc-link" data-title="Backand Dashboard">Console</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#server-side-exceptions" class="toc-h3 toc-link" data-title="Backand Dashboard">Server Side Exceptions</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#configuration-2" class="toc-h3 toc-link" data-title="Backand Dashboard">Configuration</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#data-history" class="toc-h3 toc-link" data-title="Backand Dashboard">Data History</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
                  <li>
                    <a href="#settings" class="toc-h2 toc-link" data-title="Backand Dashboard">Settings</a>
                      <ul class="toc-list-h3">
                          <li>
                            <a href="#general" class="toc-h3 toc-link" data-title="Backand Dashboard">General</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#database-2" class="toc-h3 toc-link" data-title="Backand Dashboard">Database</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#configuration-3" class="toc-h3 toc-link" data-title="Backand Dashboard">Configuration</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#billing-portal" class="toc-h3 toc-link" data-title="Backand Dashboard">Billing Portal</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#upgrade-plan" class="toc-h3 toc-link" data-title="Backand Dashboard">Upgrade Plan</a>
                            <!-- Nest 4 levels -->
                          </li>
                          <li>
                            <a href="#payment-method" class="toc-h3 toc-link" data-title="Backand Dashboard">Payment Method</a>
                            <!-- Nest 4 levels -->
                          </li>
                      </ul>
                  </li>
...
<li>You can manage user security and access to your application automatically through Backand&#39;s security and authorization system</li>
<li>You can test every single endpoint in your system using Backand&#39;s API Playground</li>
<li>You can get immediate and up-to-date looks at your database&#39;s underlying tables and stored data, and even perform real-time manipulations of that data</li>
...
<p>Let&#39;s take a quick look at each available action in the Backand dashboard, and get started with focusing on the front-end of your application!</p>
<h2 id='navigation-mapping'>Navigation mapping</h2>
<p>Below is a list of pages in the Backand dashboard, and links to the specific section of the dashboard documentation that is relevant for each. We recommend using this as your starting point - it is designed to represent the hierarchy of pages as they currently appear in the Backand dashboard</p>
<h3 id='functions-amp-integrations'>Functions &amp; Integrations</h3>
<p>The Functions &amp; Integrations section of the Backand dashboard is dedicated to managing serverless functions in your Backand application. You&#39;ll find all object-independent functions here, as well as Cron Job management.</p>

<ul>
<li>Docs &amp; API

<ul>
<li><a href="https://www.backand.com/app-examples/">Examples</a> - A set of examples built on top of the Backand platform</li>
<li><a href="http://docs.backand.com/">Documentation</a> - This documentation</li>
</ul></li>
<li>Functions

<ul>
<li><a href="#external-lambda-functions">External Functions</a> - This tab allows you to connect your AWS account and import external AWS Lambda functions.</li>
<li><a href="#server-side-node-js-code">Add Lambda Function</a> - This governs adding a new Backand-owned Lambda function. Please note that these are different from external Lambda functions, which are owned by you.</li>
<li><a href="#custom-actions">Add Javascript Function</a> - This governs adding a new Backand Server-side JavaScript function.</li>
<li><a href="#custom-actions">Function list</a></li>
</ul></li>
<li><a href="#background-jobs">Cron Jobs</a> - This governs the list of scheduled tasks currently being used by your application

<ul>
<li>New Job - Use this page to create a new <a href="#background-jobs">Cron Job</a></li>
<li>Cron Job list - This lists all scheduled jobs currently available in your application</li>
</ul></li>
<li><a href="#api-requests">API Log</a> - This is a log of your application&#39;s API requests</li>
<li><a href="#console">Console Log</a> - This is a log of all console output from your application&#39;s functions and actions</li>
</ul>
<h3 id='database'>Database</h3>
<p>The Database section of the Backand dashboard is used to manage your application&#39;s data store and schema. You can update your application&#39;s model, work with your object data, or construct custom queries against your database that can be called on-demand.</p>

<ul>
<li><a href="http://localhost:4567/#docs-amp-api">Docs &amp; API</a> - Product documentation

<ul>
<li><a href="#examples">Examples</a> - A set of example programs you can use to boost your development</li>
<li><a href="#kickstart-tutorials">Kickstart Tutorials</a> - A set of kickstart apps, already connected to a demonstration Backand application</li>
<li><a href="#existing-app-tutorials">Existing app</a> - A set of tutorials for connecting Backand with a pre-existing app built on any of a number of popular JavaScript frameworks</li>
<li><a href="#realtime-database">Realtime Database</a> - Documentation on using our real-time database functionality, built on top of Socket.IO</li>
<li><a href="#documentation">Documentation</a> - A link to this documentation</li>
<li><a href="#rest-api-playground">REST API Playground</a> - Swagger-generated documentation for your application&#39;s REST API</li>
</ul></li>
<li><a href="#model">Model</a> - This provides tools for managing your application&#39;s data model</li>
<li><a href="#objects">Objects</a> - This is a list of objects available in your application. Each object page contains data management, custom actions, security configuration, and an API playground.

<ul>
<li>New Object - Use this tab to create a new object in your system. It redirects you to the <a href="#model">Model</a> editor.</li>
<li><a href="#object-list">Object List</a></li>
</ul></li>
<li><a href="#queries">Queries</a> - This section allows you to manage your application&#39;s custom queries.

<ul>
<li><a href="#create-a-query">New Query</a> - Use this tab to create a new custom query in your application.</li>
<li><a href="#query-list">Query list</a> - A list of all queries in your system. Each query has a UI for testing.</li>
</ul></li>
<li><a href="#log">All logs</a>

<ul>
<li><a href="#api-requests">API Log</a> - This is a log of your application&#39;s API requests</li>
<li><a href="#console">Console Log</a> - This is a log of all console output from your application&#39;s functions and actions</li>
<li><a href="#data-history">Data History log</a> - This is a log of data changes in your application. This is only active if data logging is enabled on an object&#39;s configuration page</li>
<li><a href="#server-side-exceptions">Server Exceptions</a> - This lists all server-side exceptions that have occurred in your application.</li>
<li><a href="#configuration-2">Configuration</a> - This is a log of all configuration changes that have been applied to your application</li>
</ul></li>
<li><a href="#setting-up-and-configuring-a-database">Database Settings</a> - This contains all settings related to managing your application&#39;s database connection</li>
</ul>
<h3 id='security'>Security</h3>
<p>The Security section of the Backand Dashboard is used to manage user and access restrictions for your application. You also obtain the API keys for your Backand application here.</p>

<ul>
<li><a href="#security-configuration">Configuration</a> - Use this to configure security-related functionality (like password resets) and obtain your anonymous access token</li>
<li><a href="#social-amp-keys">Social &amp; Keys</a> - Use this to configure your connection with social media providers, and obtain your application&#39;s master and API signup keys</li>
<li><a href="#registered-users">Registered Users</a> - This datagrid is used to manage your application&#39;s registered users</li>
<li><a href="#security-actions-backand-dashboard">Security Actions</a> - This set of custom actions provides you the capability to perform various application updates after each user registration or security action. You can also use these actions to implement <a href="#integrating-third-party-security">third-party security mechanisms</a>.</li>
<li><a href="#security-templates">Security Templates</a> - Use this section to manage your application&#39;s security templates and user security roles</li>
</ul>
<h3 id='admin'>Admin</h3>
<p>The Admin section contains all the tools you need to administer your Backand account, and manage your application&#39;s hosting and environment variables.</p>

<ul>
<li><a href="#general">General</a> - This section allows you to manage your application&#39;s global configuration settings</li>
<li><a href="#team">Team</a> - Use this datagrid to add or remove administrators in your Backand application</li>
<li><a href="#hosting">Hosting</a> - This section governs Backand-provided hosting and file storage access

<ul>
<li><a href="#configuration">Configuration</a> - This is used to set up your application&#39;s usage for Backand hosting</li>
<li><a href="#storage-files">Storage</a> - This provides an interface to manage all files stored in S3 on behalf of your application</li>
</ul></li>
<li><a href="#configuration-3">App Configuration</a> - This allows you to create versions of your application&#39;s configuration settings</li>
<li>Billing

<ul>
<li><a href="#billing-portal">Billing Portal</a> - This allows you to review billing information that you have provided to Backand</li>
<li><a href="#upgrade-plan">Upgrade Plan</a> - Use this page to perform an account upgrade</li>
<li><a href="#payment-method">Payment Method</a> - This page allows you to update and change your application&#39;s payment methods</li>
</ul></li>
<li><a href="#analytics">Reports</a> - This section provides access to your application&#39;s analytics</li>
<li><a href="#log">All logs</a>
...
<h2 id='docs-amp-api'>Docs &amp; API</h2>
<p>The Docs &amp; API tab contains links to kickstart tutorials, tutorials on converting existing applications to use Backand, and other useful documentation. let&#39;s take a look at each menu category below.</p>
...
<p>The Model Diagram tab provides a GUI editor for working with your app&#39;s database schema. It works with the model JSON in the background to orchestrate changes to your database. Using the GUI you can easily add new objects, update existing objects, create relations between objects, and all other related database modification tasks.</p>
<h4 id='model-json'>Model JSON</h4>
<p>The Model JSON tab provides a straightforward method of editing your database schema using well-formed JSON. You&#39;re given a pane to perform your edits, and a comparison pane so that you can easily see what has changed from the current schema. Once your changes are finalized, click &quot;Validate &amp; Update&quot; to finalize your changes.</p>
<h4 id='database-pending'>Database (pending)</h4>
<p>This tab describes how to make the changes you desire in your model directly in the database. Once you&#39;ve made your changes via whichever RDBMS tool you prefer, you can click the &quot;Sync your database&quot; button to pull the changes into Backand, updating your schema and object list.</p>
<h3 id='object-list'>Object List</h3>
<p>For each object in your schema, you are provided a dedicated management area for that object. These are accessed via a list beneath the &quot;New object&quot; entry.</p>

<p>Each object has a set of tabs provided that allow you to modify either the object&#39;s data, or the object itself. These tabs are Data, Actions, Security, Settings, and REST API</p>
...
<p>We also give you access to the Filter Data functionality, which can be used to quickly construct request filters that can be applied to GET requests. Simply click on the &quot;Filter Data&quot; link to expose a UI for constructing your filter, and the resulting parameter code will appear in the &quot;Request Code&quot; textbox on the right side of the screen.</p>
...
<p>The security tab allows you to create custom filters that apply restrictions to loading data associated with the user session. You can also use this tab to override your app&#39;s global security configuration, allowing custom access to your object based on user role, and also restrict access to specific fields in the object as necessary.</p>
...
<p>The field properties provide you with the capability to make a field searchable (available via the &quot;Search&quot; filter when making API calls), mark a field as &quot;required&quot;, or provide a default value for a field. These options are presented for each field in your object, but depending on usage may not be modifiable. If a field represents a link to another object in your system, you are provided with a hyperlink in the settings section that takes you directly to that related object&#39;s datagrid view.</p>
...
<p>The queries tab provides you with the capability to generate custom queries in your system. Simply click &quot;New Query&quot; to start building out a custom query. When building a new query you can provide a name, input parameters, and the query body using either NoSQL or SQL syntax. You can also set the security template of the query, restricting the query access based on the user&#39;s role. On the right side of this screen, you can also perform a quick test of your query by hitting either &quot;Test Query&quot; or &quot;Save &amp; Test&quot;. The test process will present the query&#39;s URL endpoint, the SDK code needed to call the query, and a sample response.</p>
<h3 id='query-list'>Query List</h3>
<p>As you create queries, you&#39;re provided with a list of the queries present in your system. Simply click on the name of a query to begin editing or testing the query&#39;s contents.</p>
<h3 id='create-a-query'>Create a query</h3>
<p>You can add a new query by clicking on &quot;+New Query&quot; in the menu bar. This allows you to name the query, provide any parameters necessary, and then write the query. It also allows you to set a specific security template for the query to use as it executes, and allows you to override the security template settings when running the query.</p>
<h3 id='update-an-existing-query'>Update an existing query</h3>
<p>To update an existing query, select the query from the navigation menu and press the &quot;Edit&quot; button.</p>
...
<p>Background jobs (also known as cron jobs) allow you to run an action, query, or external URL request on a schedule that you define. Simply set the time and frequency, and the desired task will be executed automatically by Backand&#39;s servers. With this mechanism, you can run periodic queries for things like reports, recurring actions to control your application&#39;s behavior, or regularly post to external services.</p>
<h3 id='create-a-job'>Create a job</h3>
<p>To create a new Background job, click on &quot;+ New Job&quot; in the &quot;Background jobs&quot; section of the navigation bar. Simply add a name, a description, a start time or frequency, and set the type of job (Action, Query, External URL) to execute.</p>
...
<p>This can be very useful in distinguishing between two jobs that run the same action. For each job, you can send a &quot;type&quot; parameter to indicate the specific job being run. You can accomplish this by setting the &quot;Query String&quot; field to the appropriate value: <code>parameters={type:1}</code> for job 1, and <code>parameters={type:2}</code> for job 2.</p>
<h3 id='update-an-existing-job'>Update an existing job</h3>
<p>You can update existing job by selecting the background job from the navigation menu and pressing the &quot;Edit&quot; button. This allows you to change all aspects of the job.</p>
...
<h3 id='run-background-job-using-rest-api'>Run background job using REST API</h3><pre class="highlight shell tab-shell"><code>  curl https://api.backand.com/1/jobs/run/<span class="o">{</span>id<span class="o">}</span>
...
<p>All messages and errors are logged into the console. These messages are available in the dashboard under Log --&gt; Console.</p>
<h3 id='test-background-job'>Test background job</h3><pre class="highlight shell"><code>curl https://api.backand.com/1/jobs/run/<span class="o">{</span>id<span class="o">}</span>/test
</code></pre>
...
<p>The Analytics section provides several reports exploring the various facets of you app&#39;s performance. You are able to provide a date range to examine, using preconfigured date ranges our your own custom range. You can use these to gain insight on user activity within your app, as well as on the resources being used by your application.</p>
...
<h2 id='security-amp-auth'>Security &amp; Auth</h2>
...
<p>When enabled, this allows any user with a link to access your application. You can set a role for anonymous users, and obtain an anonymous access token to use in your application&#39;s code.</p>
...
<h3 id='social-amp-keys'>Social &amp; Keys</h3>
...
<h5 id='social-redirect-uris'>Social Redirect URIs</h5>
<p>Following sign-in with social media, your user will be redirected to a Redirect URI that is then tasked with obtaining the full details of the authentication that occurred. This URI is called automatically by Backand, and is specified as the redirectUrl parameter to the socialMediaSignup call in the API. In order to support this more secure pattern of working with social media authentication, all URLs that can be redirected to must be present in this Social Redirect URI list. If a URL is not present in this list, then the redirect request will not be honored.</p>
...
<ol>
<li>Check the &#39;Use your credentials for signing in with GitHub&#39; toggle</li>
<li>Register your application on GitHub&#39;s <a href="https://github.com/settings/applications/new" target="\_blank">Developer Applications Tab</a>. Include the following details, which are mandatory for new applications:

<ul>
<li><code>Application name</code>: A name for your app. Something users will recognize and trust</li>
<li><code>Homepage URL</code>: Your application&#39;s url (you can use http://localhost for testing purposes)</li>
<li><code>Authorization callback URL</code>: https://api.backand.com/1/user/github/auth</li>
</ul></li>
<li>Record the Client ID and the Client Secret from GitHub</li>
<li>Finally, on the <code>Social &amp; Keys</code> section of the Backand app management dashboard, copy the Client ID and Client Secret in the correct fields in the GitHub section..</li>
</ol>
...
<ol>
<li>Check the &#39;Use your credentials for signing in with Google&#39; toggle/</li>
<li>Open the <a href="https://console.developers.google.com/project" target="\_blank">Google Developer&#39;s Console</a>.

<ol>
<li>In the Google Developer&#39;s Console, Click <strong>Create Project</strong>.</li>
<li>Enter a name, or accept the defaults, and click <strong>Create</strong>.</li>
<li>Click <strong>Library</strong> to view the API Library, which lists all available APIs. The APIs are grouped by product family and popularity. Click on <strong>Google+ API</strong> under <strong>Social APIs</strong></li>
<li>Click <strong>Enable</strong> (You should see this to the right of the Google+ API button).</li>
...
<li>Enter the following details:
    ...
    * <strong>Authorized redirect URIs</strong>: Replace the default example URL with &#39;https://api.backand.com/1/user/google/auth&#39;
...
<li>On the left side bar click <strong>Dasboard</strong> make sure Google+ API is listed under the <strong>API</strong> list. On the right side of the list, make sure that the displayed action text is <strong>disable</strong>, indicating that the API is currently enabled.</li>
</ol></li>
...
<ol>
<li>Check the &#39;Use your credentials for signing in with Facebook&#39; toggle.</li>
...
<li>In the wizard that follows, provide your app&#39;s name and <strong>Category</strong></li>
...
<li>In <strong>Valid OAuth redirect URIs</strong> enter: &#39;https://api.backand.com/1/user/facebook/auth&#39;</li>
<li>Click <strong>Save Changes</strong></li>
<li>To start using your app, you need to make it public, open App Preview from the left menu and change <strong>Make
<code>{{appName}}</code> public?</strong> to <strong>yes</strong> and confirm the popup window</li>
...
<ol>
<li>Un-check the &#39;Use Back&amp; app for signing in with Twitter&#39; toggle.</li>
<li>If you haven&#39;t added your phone number to Twitter you&#39;ll need to add it before creating Twitter app, please follow <a href="https://support.twitter.com/articles/110250">these instructions</a></li>
...
<li>Run this command to configure persistent Single Sign-On and show the &quot;keep me signed in&quot; checkbox:</li>
...
<li><p>Click on &quot;Endpoints&quot; menu and copy &quot;OAUTH 2.0 AUTHORIZATION ENDPOINT&quot;. In Backand just connect to /oauth2 in the OAUTH 2.0 Endpoint filed(e.g. &quot;https://login.windows.net/a652911c-7a2c-4a9c-d1b2-d149256f461b/oauth2&quot;)</p></li>
...
<h3 id='team'>Team</h3>
<p>The Team section allows you to add new administrative users to your application. Admin users have full access to the application dashboard, and your application&#39;s configuration. You can perform all of the same actions available on the Users page on the Team page as well.</p>
<h3 id='security-actions-backand-dashboard'>Security Actions (Backand Dashboard)</h3>
...
<p>The following actions are provided by default for a Backand application. You can edit these actions as you desire, or add new actions that occur during the database transaction that modifies your app&#39;s <code>registered_users</code> table:</p>
...
<td>Automatic, after a call to <code>requestResetPassword</code></td>
<td>This email is sent in response to initiating a password reset</td>
</tr>
<tr>
<td>socialAuthOverride</td>
<td>Automatic, after social media authentication <em>and</em> registration</td>
<td>See <a href="#integrating-third-party-security">our post on third-party security</a></td>
</tr>
<tr>
<td>userApproval</td>
...
<td>Automatic, during user creation</td>
<td>This function takes the user input from the sdk <code>signup</code> call, and uses it to populate a custom <code>users</code> object in your application.</td>
</tr>
<tr>
...
<td>This action occurs whenever a registered user is modified. It attempts to make the appropriate modifications in your app&#39;s custom <code>users</code> object</td>
</tr>
<tr>
<td>Delete My App User</td>
<td>Automatic, during user deletion</td>
<td>This action occurs whenever a registered user is deleted. It attempts to remove the associated <code>users</code> record for the user being deleted.</td>
</tr>
</tbody></table>
...
<p>This page provides dynamic information designed to walk you through the relevant steps for the current stage of your hosting effort. Follow the provided guide to initiate, update, and deploy your project&#39;s hosting.</p>
...
<p>The Storage Files section lists the files stored in S3 on behalf of your application. You can view the list of files, upload a new file, download a file, or delete a file from your app&#39;s s3 storage.</p>
<h2 id='log'>Log</h2>
<p>The Log menu item provides access to Backand&#39;s built in logging functionality. We provide a number of different logs with different targets, allowing you to easily see all activity in your application in one place.</p>
...
<p>The Console log logs all console messages created by your application&#39;s actions. You can use this when troubleshooting server-side actions to ensure that all messages are being received correctly, and you can filter the log messages to match your current debugging scenario.</p>
<h3 id='server-side-exceptions'>Server Side Exceptions</h3>
<p>The Server Side Exceptions log provides access to any server-side exceptions generated during your app&#39;s execution. Details on the exception are provided, and you are given the capability to filter the logs based on arbitrary criteria.</p>
<h3 id='configuration-2'>Configuration</h3>
<p>The Configuration log tracks all configuration changes made to your application. This includes all actions taken in your application&#39;s Backand dashboard, recording the action taken and the user responsible. You can also filter the log by any of the provided fields.</p>
...
<p>The Configuration tab allows you to version your app&#39;s configuration. You can export and import settings, or work with previous application configurations.</p>
